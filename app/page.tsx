  ...
  return (
    <PageWrapper>
      ...
      <div className="flex-1 flex items-center justify-center">
        <Section hero>
          <div className="relative z-10 flex w-full flex-col md:items-start items-center gap-8 text-center p-4 py-8">
            ...
            <p className="text-[clamp(0,3vw,1.25rem)] md:text-xl text-black/80 max-w-3xl text-pretty md:text-left drop-shadow-lg tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <LiquidButton
                variant="default"
                className="rounded-full text-zinc-800 flex flex-row gap-3 tracking-tight text-lg"
      ...
      <Section className="flex-col gap-10">
        <h2 className="text-4xl font-black leading-tighter tracking-tighter text-black md:text-5xl text-center md:text-left drop-shadow-2xl w-full">
          Bla bla bla...
        </h2>
